...
if (typeof(Delicious.BlogBadge)=='undefined') {
    ...
    Delicious.BlogBadge = function() {
        return {
            ...
            DEBUG:           false,
            url_root:        Delicious.URL_ROOT        || 'http://www.delicious.com',
            post_url_root:   Delicious.POST_URL_ROOT   || 'http://www.delicious.com/save',
            json_url_root:   Delicious.JSON_URL_ROOT   || 'http://feeds.delicious.com/v2/json/urlinfo',
            static_url_root: Delicious.STATIC_URL_ROOT || 'http://static.delicious.com',
